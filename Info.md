...
Существует еще один способ работы с удаленным репозиторием.

Это команда:
> git remote

которая имеет три подкоманды:
> git remote -v 

выдает перечень удаленных репозиториев, ассоциированных с нашим локальным репозиторием.
> git remote add [name][URL]

создает удаленный репозиторий с указанным именем и адресом в сети, который является точной копией нашего локального рпеозитория со всеми файлами и коммитами.
> git remote remove [name]

удаляет указанный репозиторий в сети (удаленный репозиторий).
